#!/usr/bin/env python3
"""
AIronman 42-Day Data Sync Script (Container Version)

This script is designed to run inside the Docker container where all dependencies
are available. It pulls the last 42 days of workouts and health data from Garmin Connect
to establish the foundation for CTL calculation.

Usage inside container:
    docker exec -it aironman-1-backend-1 python /app/scripts/sync_42_days_container.py
...
# Constants
DATA_DIR = Path("/app/data")  # Container path
DAYS_TO_SYNC = 42
...
def main():
    ...
    print("🚀 AIronman 42-Day Data Sync (Container Version)")
